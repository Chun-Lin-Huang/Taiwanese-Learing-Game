...
import { MonopolyHistoryService } from "../Service/MonopolyHistoryService";
import { MonopolyHistory, GameAction } from "../interfaces/MonopolyHistory";

export class MonopolyHistoryController {
  private service: MonopolyHistoryService;

  constructor() {
    this.service = new MonopolyHistoryService();
  }
